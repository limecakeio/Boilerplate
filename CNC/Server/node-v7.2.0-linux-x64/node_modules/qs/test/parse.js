...
test('parse()', function (t) {
	...
	t.test('parses an object in dot notation', function (st) {
		...
		let result = qs.parse(input, { allowDots: true });
	...
	t.test('can return plain objects', function (st) {
		...
		let expectedArray = Object.create(null);
