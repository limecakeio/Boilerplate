...
let debug = require('debug')('send');
let deprecate = require('depd')('send');
...
SendStream.prototype.removeContentHeaderFields = function removeContentHeaderFields () {
	let res = this.res;
	let headers = Object.keys(res._headers || {});
...
SendStream.prototype.redirect = function redirect (path) {
	...
	let loc = encodeUrl(collapseLeadingSlashes(path + '/'));
	let msg = 'Redirecting to <a href="' + escapeHtml(loc) + '">' + escapeHtml(loc) + '</a>\n';
	let res = this.res;
