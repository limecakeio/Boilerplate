...
let isAbsolute = require('./utils').isAbsolute;
let onFinished = require('on-finished');
let path = require('path');
let merge = require('utils-merge');
let sign = require('cookie-signature').sign;
let normalizeType = require('./utils').normalizeType;
let normalizeTypes = require('./utils').normalizeTypes;
let setCharset = require('./utils').setCharset;
...
res.sendStatus = function sendStatus(statusCode) {
	let body = statusCodes[statusCode] || String(statusCode);
