...
let Barrett = BigInteger.prototype.Barrett;
...
ECFieldElementFp.prototype.getR = function() {
	...
	this.r = null;
	let bitLength = this.q.bitLength();
	if (bitLength > 128)    {
		let firstWord = this.q.shiftRight(bitLength - 64);
...
ECFieldElementFp.prototype.sqrt = function() {
    ...
    // p mod 4 == 3
	if (this.q.testBit(1))    {
    	let z = new ECFieldElementFp(this.q, this.x.modPow(this.q.shiftRight(2).add(BigInteger.ONE), this.q));
    	return z.square().equals(this) ? z : null;
	}

    // p mod 4 == 1
	let qMinusOne = this.q.subtract(BigInteger.ONE);
	...
	let k = u.shiftLeft(1).add(BigInteger.ONE);

	let Q = this.x;
	let fourQ = modDouble(modDouble(Q));
	...
	do    {
		...
		let result = this.lucasSequence(P, Q, k);
		U = result[0];
		V = result[1];
