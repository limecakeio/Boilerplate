...
let FingerprintFormatError = errs.FingerprintFormatError;
...
Fingerprint.prototype.matches = function (other) {
	...
	let theirHash = other.hash(this.algorithm);
	let theirHash2 = crypto.createHash(this.algorithm).
