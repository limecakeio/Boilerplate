...
exports.parseHost = function (req, hostHeaderName) {
	...
	let hostHeader = req.headers[hostHeaderName];
	if (!hostHeader) {
		return null;
	}
	...
	let hostParts = hostHeader.match(internals.hostHeaderRegex);
	if (!hostParts) {
		return null;
	}
...
exports.parseAuthorizationHeader = function (header, keys) {
	...
	let headerParts = header.match(internals.authHeaderRegex);
	if (!headerParts) {
