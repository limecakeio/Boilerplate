...
let credentialsFunc = function (id, callback) {
...
let handler = function (req, res) {
	...
	Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
		...
		let payload = (!err ? 'Hello ' + credentials.user + ' ' + artifacts.ext : 'Shoosh!');
		let headers = {
...
credentialsFunc('dh37fgj492je', function (err, credentials) {
	...
	let header = Hawk.client.header('http://127.0.0.1:8000/resource/1?b=1&a=2', 'GET', { credentials: credentials, ext: 'and welcome!' });
	let options = {
	...
	Request(options, function (error, response, body) {
		...
		let isValid = Hawk.client.authenticate(response, credentials, header.artifacts, { payload: body });
