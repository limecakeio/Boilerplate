...
test('read byte', function(t) {
	let reader = new BerReader(new Buffer([ 0xde ]));
	t.ok(reader);
...
test('read 1 byte int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x01, 0x03 ]));
	t.ok(reader);
...
test('read 2 byte int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x02, 0x7e, 0xde ]));
	t.ok(reader);
...
test('read 3 byte int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x03, 0x7e, 0xde, 0x03 ]));
	t.ok(reader);
...
test('read 4 byte int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x04, 0x7e, 0xde, 0x03, 0x01 ]));
	t.ok(reader);
...
test('read 1 byte negative int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x01, 0xdc ]));
	t.ok(reader);
...
test('read 2 byte negative int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x02, 0xc0, 0x4e ]));
	t.ok(reader);
...
test('read 3 byte negative int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x03, 0xff, 0x00, 0x19 ]));
	t.ok(reader);
...
test('read 4 byte negative int', function(t) {
	let reader = new BerReader(new Buffer([ 0x02, 0x04, 0x91, 0x7c, 0x22, 0x1f ]));
	t.ok(reader);
...
test('read boolean true', function(t) {
	let reader = new BerReader(new Buffer([ 0x01, 0x01, 0xff ]));
	t.ok(reader);
...
test('read boolean false', function(t) {
	let reader = new BerReader(new Buffer([ 0x01, 0x01, 0x00 ]));
	t.ok(reader);
...
test('read enumeration', function(t) {
	let reader = new BerReader(new Buffer([ 0x0a, 0x01, 0x20 ]));
	t.ok(reader);
...
test('read string', function(t) {
	...
	let buf = new Buffer(dn.length + 2);
	buf[0] = 0x04;
	buf[1] = Buffer.byteLength(dn);
	buf.write(dn, 2);
	let reader = new BerReader(buf);
	t.ok(reader);
...
test('read sequence', function(t) {
	let reader = new BerReader(new Buffer([ 0x30, 0x03, 0x01, 0x01, 0xff ]));
	t.ok(reader);
...
test('long string', function(t) {
	...
	buf[2] = 0x94;
	buf.write(s, 3);
	let ber = new BerReader(buf.slice(0, 3 + s.length));
