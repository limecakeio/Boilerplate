...
let KeyParseError = errs.KeyParseError;
...
function Key(opts) {
	...
	let algInfo = algs.info[opts.type];
	...
	if (this.type === 'ecdsa') {
		let curve = this.part.curve.data.toString();
		this.curve = curve;
		...
		let szPart = this.part[algInfo.sizePart];
...
Key.prototype.createVerify = function (hashAlgo) {
	...
	let oldVerify = v.verify.bind(v);
	let key = this.toBuffer('pkcs8');
	let self = this;
