...
let ECPointFp = require("./lib/ec.js").ECPointFp;
...
exports.ECKey = function(curve, key, isPublic) {
	...
	let c = curve();
	let n = c.getN();
	let bytes = Math.floor(n.bitLength() / 8);
...
//        curve.fromBigInteger(new BigInteger(y.toString("hex"), 16)));
		...
		let r = new BigInteger(crypto.randomBytes(n.bitLength()));
