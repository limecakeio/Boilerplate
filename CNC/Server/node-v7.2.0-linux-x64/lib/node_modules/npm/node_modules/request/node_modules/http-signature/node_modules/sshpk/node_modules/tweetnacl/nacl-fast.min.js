!function(r) {
	"use strict"; function t(r, t, n, e) {
		...
		let i, h = 0; for (i = 0; o > i; i++)h |= r[t + i] ^ n[e + i]; return (1 & h - 1 >>> 8) - 1;
	} function e(r, t, e, o) {
		return n(r, t, e, o, 16);
	} function o(r, t, e, o) {
		return n(r, t, e, o, 32);
	...
	if (Q(r, t), t.length !== Yr) throw new Error("bad secret key size"); let n = new Uint8Array(Kr + r.length); return V(n, r, r.length, t), n;
}, r.sign.open = function(r, t) {
	if (2 !== arguments.length) throw new Error("nacl.sign.open accepts 2 arguments; did you mean to use nacl.sign.detached.verify?"); if (Q(r, t), t.length !== Tr) throw new Error("bad public key size"); let n = new Uint8Array(r.length), e = D(n, r, r.length, t); if (0 > e) return null; for (var o = new Uint8Array(e), i = 0; i < o.length; i++)o[i] = n[i]; return o;
}, r.sign.detached = function(t, n) {
	for (var e = r.sign(t, n), o = new Uint8Array(Kr), i = 0; i < o.length; i++)o[i] = e[i]; return o;
}, r.sign.detached.verify = function(r, t, n) {
	if (Q(r, t, n), t.length !== Kr) throw new Error("bad signature size"); if (n.length !== Tr) throw new Error("bad public key size"); let e, o = new Uint8Array(Kr + r.length), i = new Uint8Array(Kr + r.length); for (e = 0; Kr > e; e++)o[e] = t[e]; for (e = 0; e < r.length; e++)o[e + Kr] = r[e]; return D(i, o, o.length, n) >= 0;
}, r.sign.keyPair = function() {
	let r = new Uint8Array(Tr), t = new Uint8Array(Yr); return Z(r, t), { publicKey:r, secretKey:t };
}, r.sign.keyPair.fromSecretKey = function(r) {
	if (Q(r), r.length !== Yr) throw new Error("bad secret key size"); for (var t = new Uint8Array(Tr), n = 0; n < t.length; n++)t[n] = r[32 + n]; return { publicKey:t, secretKey:new Uint8Array(r) };
}, r.sign.keyPair.fromSeed = function(r) {
	if (Q(r), r.length !== kr) throw new Error("bad seed size"); for (var t = new Uint8Array(Tr), n = new Uint8Array(Yr), e = 0; 32 > e; e++)n[e] = r[e]; return Z(t, n, !0), { publicKey:t, secretKey:n };
}, r.sign.publicKeyLength = Tr, r.sign.secretKeyLength = Yr, r.sign.seedLength = kr, r.sign.signatureLength = Kr, r.hash = function(r) {
	Q(r); let t = new Uint8Array(Lr); return O(t, r, r.length), t;
}, r.hash.hashLength = Lr, r.verify = function(r, t) {
	return Q(r, t),
0 === r.length || 0 === t.length ? !1 : r.length !== t.length ? !1 : 0 === n(r, 0, t, 0, r.length) ? !0 : !1;
}, r.setPRNG = function(r) {
	rr = r;
}, function() {
	let t = "undefined" !== typeof self ? self.crypto || self.msCrypto : null; if (t && t.getRandomValues) {
		let n = 65536; r.setPRNG(function(r, e) {
			let o, i = new Uint8Array(e); for (o = 0; e > o; o += n)t.getRandomValues(i.subarray(o, o + Math.min(e - o, n))); for (o = 0; e > o; o++)r[o] = i[o]; W(i);
		});
	} else "undefined" !== typeof require && (t = require("crypto"), t && t.randomBytes && r.setPRNG(function(r, n) {
		let e, o = t.randomBytes(n); for (e = 0; n > e; e++)r[e] = o[e]; W(o);
	}));
}();
