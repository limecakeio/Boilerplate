...
let readlink = require('graceful-readlink').readlinkSync;
...
Command.prototype.command = function(name, desc, opts) {
	opts = opts || {};
	let args = name.split(/ +/);
	let cmd = new Command(args.shift());
...
Command.prototype.opts = function() {
	...
	for (let i = 0; i < len; i++) {
		let key = camelcase(this.options[i].name());
...
Command.prototype.commandHelp = function() {
	...
	let commands = this.commands.filter(function(cmd) {
		return !cmd._noHelp;
	}).map(function(cmd) {
