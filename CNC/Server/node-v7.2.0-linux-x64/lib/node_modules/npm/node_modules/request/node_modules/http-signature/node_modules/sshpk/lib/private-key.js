...
let KeyEncryptedError = errs.KeyEncryptedError;
...
PrivateKey.prototype.toPublic = function () {
	...
	let algInfo = algs.info[this.type];
	let pubParts = [];
	for (let i = 0; i < algInfo.parts.length; ++i) {
		let p = algInfo.parts[i];
...
PrivateKey.prototype.createSign = function (hashAlgo) {
	...
	let oldSign = v.sign.bind(v);
	let key = this.toBuffer('pkcs1');
	let type = this.type;
	v.sign = function () {
		let sig = oldSign(key);
