...
subcommands.grant = function (uri, params, cb) {
	let reqUri = apiUri(uri, 'team', params.scope, params.team, 'package');
...
subcommands['ls-packages'] = function (uri, params, cb, type) {
	...
	let reqUri = apiUri(uri, type, params.scope, params.team, 'package');
...
subcommands['ls-collaborators'] = function (uri, params, cb) {
	...
	let reqUri = apiUri(uri, 'package', params.package, 'collaborators');
