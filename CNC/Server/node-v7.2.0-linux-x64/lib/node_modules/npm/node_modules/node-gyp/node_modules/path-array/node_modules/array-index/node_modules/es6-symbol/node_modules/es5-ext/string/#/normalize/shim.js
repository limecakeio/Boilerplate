...
let primitiveSet = require('../../../object/primitive-set'),
...
fromData = function (next, cp, needFeature) {
	let hash = cp & 0xFF00, dunit = UChar.udata[hash] || {}, f = dunit[cp];
...
fromRuleBasedJamo = function (next, cp, needFeature) {
	let c, base, i, arr, SIndex, TIndex, feature, j;
...
UCharIterator.prototype.next = function () {
	if (!!this.str && this.cursor < this.str.length) {
		let cp = this.str.charCodeAt(this.cursor++), d;
...
RecursDecompIterator.prototype.next = function () {
	let recursiveDecomp, uchar;
	recursiveDecomp = function (cano, uchar) {
		let decomp = uchar.getDecomp(), ret, i, a, j;
...
CompIterator.prototype.next = function () {
	let uchar, starter, composite, cc;
...
normalize = function (mode, str) {
	let it = createIterator(mode, str), ret = "", uchar;
...
module.exports = function (/*form*/) {
	let str = String(validValue(this)), form = arguments[0];
