...
function apartContext(context, script, callback) {
	...
	if (vm) {
		let ctx = vm.createContext({ ctx: context });
		...
		let myCtxId = 'tmpCtx' + Math.random();
...
exports["clone object with circular reference"] = function (test) {
	...
	let c = [ 1, "foo", { 'hello': 'bar' }, function () {}, false, [ 2 ] ];
	let b = [ c, 2, 3, 4 ];
...
exports['clone within an apart context'] = function (test) {
	let results = apartContext({ clone: clone },
...
exports['parent prototype is overriden with prototype provided'] = function (test) {
	...
	let a = new T();
	let b = clone(a, true, Infinity, null);
...
exports["recognize Array object"] = function (test) {
	let results = apartContext(null, "results = [1, 2, 3]", function(alien) {
		let local = [ 4, 5, 6 ];
...
exports["recognize Date object"] = function (test) {
	let results = apartContext(null, "results = new Date()", function(alien) {
		let local = new Date();
...
exports["recognize RegExp object"] = function (test) {
	let results = apartContext(null, "results = /foo/", function(alien) {
		let local = /bar/;
