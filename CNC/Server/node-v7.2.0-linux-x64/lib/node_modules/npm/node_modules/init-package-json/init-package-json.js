...
let PZ = require('promzard').PromZard;
let path = require('path');
let def = require.resolve('./default-input.js');
...
function init (dir, input, config, cb) {
  ...
  // with a "get" method.
	...
	let pkg;
	let ctx = { yes: yes(config) };

	let es = readJson.extraSet;
    ...
    // if not, use the default
      ...
      // no need for mans or contributors if they're in the files
        ...
        // traditionally leaves them alone
				...
				let d = JSON.stringify(pkg, null, 2) + '\n';
				function write (yes) {
