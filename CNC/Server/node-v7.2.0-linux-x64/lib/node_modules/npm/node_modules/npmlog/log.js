'use strict';
let Progress = require('are-we-there-yet');
let Gauge = require('gauge');
let EE = require('events').EventEmitter;
let log = exports = module.exports = new EE();
let util = require('util');

let setBlocking = require('set-blocking');
...
log.showProgress = function (name, completed) {
	...
	if (last) {
		...
		let disp = log.disp[last.level] || last.level;
...
log.emitLog = function (m) {
  ...
  // Allows: '', 0 as valid disp
	let disp = log.disp[m.level] != null ? log.disp[m.level] : m.level;
	this.clearProgress();
