...
let debug = require("debuglog")("read-installed");
...
function findUnmet (obj, opts) {
	let findUnmetSeen = opts.findUnmetSeen;
	...
	let deps = obj.dependencies = obj.dependencies || {};
	...
	let peerDeps = obj.peerDependencies = obj.peerDependencies || {};
...
function copy (obj) {
	...
	let o = {};
	for (let i in obj) o[i] = copy(obj[i]);
	return o;
}
