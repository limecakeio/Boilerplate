...
let PassThrough = require('readable-stream').PassThrough;
  ...
  // See formula at <https://github.com/tim-kos/node-retry>.
	...
	operation.attempt(function (currentAttempt) {
      ...
      // Only retry on 408, 5xx or no `response`.
			...
			let statusRetry = !sc || (sc === 408 || sc >= 500);
...
function fetchAndShaCheck (u, tmp, shasum, auth, cb) {
	...
	npm.registry.fetch(u, { auth: auth }, function (er, response) {
		...
		let tarball = writeStreamAtomic(tmp, { mode: npm.modes.file });
